...
export default function StudentManagement() {
    ...
    const openEnrollmentModal = (student: Student) => {
        ...
        setEnrollmentFormData({
            ...
            academicYearId: student.academicYearId || selectedAcademicYear?.id || '', // Update to use selectedAcademicYear
            repeater: false,
            photo: '',
        });
    ...
    const handleAssignToClass = async (e: React.FormEvent) => {
        ...
        const payload = {
            classId: parseInt(String(assignClassFormData.classId)),
            academicYearId: parseInt(String(assignClassFormData.academicYearId)),
                    ...
                    <div className="relative mx-auto p-6 border w-full max-w-4xl shadow-lg rounded-lg bg-white max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={async (e) => {
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div className="flex items-end pb-1">
                                        <div className="flex items-center h-full">
                                            ...
                                            />
                                            <label htmlFor="enrollIsNewStudent" className="ml-2 block text-sm text-gray-900">Is New Student?</label>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    {/* Academic Year is automatically set to currentAcademicYear.id */}
                                    {/* Removed Academic Year selection input */}
                                    <div>
                        ...
                        <form onSubmit={async (e) => {
                            ...
                            try {
                                ...
                                const assignmentPayload = {
                                    classId: parseInt(String(addAssignFormData.classId)),
                                    academicYearId: parseInt(String(addAssignFormData.academicYearId)),
