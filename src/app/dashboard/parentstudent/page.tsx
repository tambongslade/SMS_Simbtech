  ...
  return (
    <div className="container mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Link href={`/dashboard/super-manager/student/${dummyStudent.studentId}`} className="block hover:shadow-lg rounded-lg transition-shadow">
          <Card className="lg:col-span-1 h-full">
            ...
            <CardBody className="flex flex-col items-center space-y-3">
              ...
              <p className="text-gray-600">Admission No: {dummyStudent.admissionNo}</p>
            </CardBody>
          </Card>
        </Link>
