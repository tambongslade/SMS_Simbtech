        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
            <div className="relative mx-auto p-6 border w-full max-w-md shadow-lg rounded-lg bg-white max-h-[90vh] overflow-y-auto">
                <div className="flex items-center mb-4">
                    ...
                    <div className="ml-3">
                        <h3 className="text-lg font-medium text-gray-900">{t('Confirm Deletion')}</h3>
                    </div>
                </div>
                <div className="mt-2">
                    <p className="text-sm text-gray-600">
                        {t('Are you sure you want to delete')} <span className="font-medium text-gray-900">{itemName || t('this item')}</span>? {t('This action cannot be undone and will permanently remove all associated data.')}
                    </p>
                </div>
