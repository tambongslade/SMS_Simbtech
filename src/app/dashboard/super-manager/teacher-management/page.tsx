  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {!isLoading && (
          <div className="md:hidden bg-white shadow-md rounded-lg divide-y divide-gray-100">
            {teachers.length === 0 && !isLoading ? (
              ...
              teachers.map((teacher) => (
                <div key={teacher.id} className="p-4 space-y-1.5">
                  <div className="flex items-center text-sm font-semibold text-gray-900 break-words">
                    <span className="inline-block h-8 w-8 rounded-full overflow-hidden bg-gray-100 mr-3">
                      {teacher.photo ? (
                        <img className="h-full w-full object-cover" src={teacher.photo} alt="" />
                      ) : (
