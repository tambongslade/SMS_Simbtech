    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
        ...
        <p className="text-gray-600 mt-1 text-sm">
          {t('Ask the Bursar for money you need, and review fee reductions, disbursements and bank verifications across the school.')}
        </p>
      </div>
          ...
          ...(user?.id ? requesterTabs(user.id) : []),
          {
            ...
            content: (
              <FinanceRequestsPanel
                ...
                description={t('Read-only view. You can also clear bank verifications you have checked.')}
                showTypeFilter
                showStatusFilter
              />
            ),
