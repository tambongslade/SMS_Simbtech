...
export default function TeacherManagementPage() {
  const { selectedAcademicYear } = useAuth(); // Use selectedAcademicYear from AuthContext
  ...
  // Filter states - note: using selectedAcademicYear from AuthContext instead of local state
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Use academic year from AuthContext
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filters Section - Note: only showing search, academic year is automatic from AuthContext */}
        <RoleManagementFilters
          searchTerm={searchTerm}
          setSearchTerm={setSearchTerm}
          academicYears={academicYears}
          selectedAcademicYear={selectedAcademicYear ? String(selectedAcademicYear.id) : ''}
          setSelectedAcademicYear={() => { }} // No-op since academic year is managed by AuthContext
          isLoading={isLoading}
